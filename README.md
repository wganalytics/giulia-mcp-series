...
**1.830 linhas · 183 testes · os 8 rodam de verdade.**
...
| 07 | [`crewai`](PRJ-07_crewai) | text-to-SQL multi-agente com **defesa em duas camadas** contra SQL injection | 62 |
...
- **183 testes onde havia zero**
- **11 defeitos corrigidos**, três deles invisíveis a teste de import — só apareceram
  ao executar
